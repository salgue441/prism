...
// sha256 helper - avoiding direct crypto import in this file
...
func (s *sha256Impl) Write(p []byte) (int, error) {
	s.data = append(s.data, p...)
	return len(p), nil
}

func (s *sha256Impl) Sum(_ []byte) []byte {
	// Import crypto/sha256 at runtime to compute hash
	// This is a placeholder - actual implementation uses crypto/sha256.Sum256
