...
import (
	...
	"github.com/carlossalguero/prism/services/config/internal/server"
...
func main() {
	...
	consulClient, err := consul.NewClient(consul.Config{
		...
		KeyPrefix:  cfg.Consul.KeyPrefix,
	})
	if err != nil {
	...
	configService := service.New(consulClient)
	...
	healthChecker.Register("consul", health.ConsulCheck(consulClient.Health))
	...
	configGRPCServer := server.NewConfigServer(configService)
	server.RegisterConfigServer(grpcServer, configGRPCServer)
...
func loadConfig() (*Config, error) {
	...
	viper.SetDefault("consul.key_prefix", "prism/")
